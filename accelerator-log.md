...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=nitashav-vmw&repo=data-service",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->data-service]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=nitashav-vmw&repo=data-service'
